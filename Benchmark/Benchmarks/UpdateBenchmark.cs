...
namespace Benchmark.Benchmarks
{
    ...
    public class UpdateBenchmark
    {
        ...
        public void Change(SchoolClass schoolClasse)
        {
        ...
        public void EFCoreUpdateTest(SchoolClass schoolClass)
        {
            ...
            try
            {
                _appDBContext.Update(schoolClass);
                _appDBContext.SaveChanges();
                transaction.Commit();
            }
            catch { }
        ...
        public void MyUpdateTest(SchoolClass schoolClass)
        {
            using var transaction = _appDBContext.Database.BeginTransaction();
            try
            {
                _appDBContext.ParametricUpdate(schoolClass, new[] { "Title", "Description" },
        ...
        public void MyUpdate()
        {
            ...
            try
            {
                _appDBContext.ParametricUpdate(vs[0], new[] { "Title", "Description" },
                new string[] { "Id", "PupilId", "AcademicSubjectId" });
                _appDBContext.SaveChanges();
                transaction.Commit();
            }
        ...
        public void MyUpdateRange()
        {
            ...
            Change(vs[0]);
            Change(vs[1]);
            _appDBContext.ParametricUpdateAndSave(vs, new[] { "Title", "Description" },
                new string[] { "Id", "PupilId", "AcademicSubjectId" });
        }
    }
}
